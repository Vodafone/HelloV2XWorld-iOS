//
//  SHBPacketHeaderImpl.h
//  VodafoneV2X
//
//  Created by Nelson Silvestre on 02/12/2021.
//
...
@protocol SHBPacketHeader <NSObject, BasicHeaderProtocol, CommonHeaderProtocol, LongPosVectorProtocol, BTPBProtocol>

@end

@interface SHBPacketHeaderImpl : NSObject<ASN1Header, InitializableWithPointer, PublicPointer, SHBPacketHeader>
